...
Вы можаце падтрымаць мяне данатам з любой карткі *(і нават крыптагрошамі)* праз [афіцыйнага telegram-бота «Tribute»](https://telegram.me/tribute/app?startapp=dn4b). Кожны такі данат дадае +100 да маёй матывацыі працягваць працу, дзякуй!
...
You can support me with a donation from any card *(and even crypto)* via [the official Tribute Telegram bot](https://telegram.me/tribute/app?startapp=dn4b). Each such donation adds +100 to my motivation to keep working, thank you!

# With crypto {#crypto}

There is an opportunity for crypto-enthusiasts to support me directly via cryptocurrencies, thank you very much!
