...
export const WANTED = [
  ...
  },
  {
    id: 'tolkien-chobit',
    title: 'Хобіт',
    subtitle: 'альбо Падарожжа туды і назад',
    year: 2025,
    pages: 368,
  ...
  {
    id: 'maur-zbor-tvorau-1',
    title: 'Збор твораў. Том 1',
    subtitle: 'Аповесці',
    year: 1975,
    pages: 374,
    printRun: 17000,
  ...
  },
  {
    ...
    year: 1931,
    pages: 24,
    url: 'https://knihi.com/Jazep_Drazdovic/Niabiesnyja_biehi.html',
  },
  {
    id: 'bychkouski-anamalija',
    title: 'Анамалія',
    subtitle: 'Калекцыя беларускай фантастыкі. Выпуск 2',
    year: 2012,
    pages: 136,
    printRun: 200,
    isbn: '978-985-6906-59-9',
    url: 'https://exlibris.by/byckouski-ales-anamalija',
  },
  {
    id: 'shycik-u-cas-nie-viarnulisia',
    title: 'У час не вярнуліся',
    year: 1975,
    pages: 158,
    printRun: 14000,
    url: 'https://fantlab.ru/edition41331',
  },
  {
    id: 'shycik-zorny-kamen',
    title: 'Зорны камень',
    year: 1967,
    pages: 212,
    printRun: 20000,
    url: 'https://fantlab.ru/edition45708',
  },
  {
    id: 'hamolka-szosty-akijan',
    title: 'Шосты акіян',
    year: 1959,
    pages: 532,
    printRun: 10000,
    url: 'https://fantlab.ru/edition84811',
  },
  {
    id: 'aleksandrovic-palot-u-minulaje',
    title: 'Палёт у мінулае',
    subtitle: '«Маладняк», 1924, № 5',
    year: 1924,
    url: 'https://fantlab.ru/edition245720',
  },
  {
    id: 'balachonau-boh-kachannia-mars',
    title: 'Бог кахання Марс',
    year: 2020,
    pages: 340,
    isbn: '978-985-7210-51-0',
    url: 'https://shafa-minsk.by/ru/shop/books/xudozhestvennaya-literatura/sovremennaya-belorusskaya-proza/bog-kaxannya-mars-syargej-balaxona%D1%9E/',
  },
  {
    id: 'lastouski-labirynty-1944',
    title: 'Лябірынты',
    subtitle: 'Навукова-фантастычнае апавяданьне',
    year: 1944,
    pages: 32,
    url: 'https://commons.wikimedia.org/wiki/File:Lastouski_Vaclau.Labirynty.djvu',
  },
  {
    id: 'lem-nieperamozny',
    title: 'Непераможны',
    ...
    url: 'https://www.goodreads.com/book/show/31833295',
  },
...
const LIBRARY_FACTS = {
  ...
  'niaklajeu-kniha-losau': { year: 2025, publisher: 'KEW', city: 'Вроцлаў', isbn: '978-83-7893-351-9' , pages: 44, cover: true },
  'mify-backauscyny': { year: 1994, publisher: 'Беларуская Энцыклапедыя', city: 'Мінск', isbn: '5-85700-162-5' , pages: 111, cover: true },
  ...
  'arlou-imiony-svabody-1': { year: 2026, publisher: 'Uladzimir Arlou', city: 'Беласток', isbn: '978-83-980428-1-9' , pages: 448, cover: true },
  ...
  'buraukin-nahavarycca-z-zorkami': { year: 2026, publisher: 'Мон літара', city: 'Мінск', isbn: '978-985-7278-56-5', pages: 142, cover: true },
  ...
  'shapran-bykau-pra-mastactva': { year: 2026, publisher: 'Мон літара', city: 'Мінск', isbn: '978-985-7278-54-1', pages: 500, cover: true },
  'buraukin-prazhytaje-napisanaje': { year: 2026, publisher: 'Мон літара', city: 'Мінск', isbn: '978-985-7278-55-8', pages: 462, cover: true },
  ...
  'tolkien-uladar-1-2008': { year: 2008, city: 'Менск', translator: 'Дзьмітры Магілеўцаў, Крысьціна Курчанкова', pages: 422, cover: true },
  ...
  'saint-exupery-malenki-prync': { year: 2023, publisher: 'Папуры', city: 'Мінск', translator: 'Ніна Мацяш', isbn: '978-985-15-5385-9', pages: 128, cover: true },
  ...
  'biblija-dore': { year: 2024, publisher: 'АСТ', city: 'Москва', translator: 'Синодальный перевод', isbn: '978-5-17-138165-3', pages: 1200, cover: true },
  'goldratt-cel': { year: 2019, publisher: 'Попурри', city: 'Минск', translator: 'Елена Федурко', isbn: '978-985-15-4287-7', pages: 400, cover: true },
  ...
  'harady-bielarusi-na-pastoukach': { year: 2001, publisher: 'Беларусь', city: 'Мінск', isbn: '985-01-0353-1' , pages: 256, cover: true },
  ...
  'irdorath-bestiarium': { year: 2026, publisher: 'Irdorath (самвыдат гурта)', isbn: '978-83-980074-1-2', pages: 80, cover: true },
  ...
  'ryzkou-dzviery-zamknionyja-na-klucy': { year: 2025, publisher: 'Tutaka', city: 'Беласток', isbn: '978-83-977676-0-7' , pages: 103, cover: true },
  ...
  'hulecki-100-manet-vkl': { year: 2022, publisher: 'Тэхналогія', city: 'Мінск', isbn: '978-985-458-328-0', pages: 80, cover: true },
  'hraviury-skaryny': { year: 1972, publisher: 'Беларусь', city: 'Мінск', cover: true },
  'aleksandrovic-kartahrafija-vkl': { year: 2021, publisher: 'Тэхналогія', city: 'Мінск', translator: 'Максім Макараў', pages: 304, cover: true },
  'adamovic-jan-niaprecki': { year: 2022, publisher: 'Логвінаў', city: 'Вільня', isbn: '978-609-492-005-9', pages: 160, cover: true },
  'karatkievich-dzikaje-palavannie': { year: 2025, publisher: 'Папуры', city: 'Мінск', isbn: '978-985-15-5957-8', pages: 272, cover: true },
  'karatkievich-kalasy-white': { year: 2025, publisher: 'Фонд Kamunikat.org, Gutenberg Publisher', isbn: '978-83-67937-73-3' , pages: 804, cover: true },
...
const BOOKS = [
  ...
  book('tradycyjny-svietapohlad-1', 'І. М. Дубянецкая, С. І. Санько', 'Традыцыйны светапогляд беларусаў. Кніга 1. Касмалогія', 'be', 'folk', '#2b3160', '#e3a93c'),
