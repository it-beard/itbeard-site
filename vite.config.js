...
// 'vinils' and 'books' are unlisted, but they still get folders so the direct links answer 200
const ROUTES = ['about', 'experience', 'archive', 'support', 'sponsorship', 'help', 'contacts', 'mediakit', 'vinils', 'books']
